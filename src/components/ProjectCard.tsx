...
import { GithubLogo, Globe, Star, Code, Link, Trash, Medal } from 'phosphor-react';
...
const ProjectCard = ({ project, onDelete }: ProjectCardProps) => {
  ...
  return (
    <div className="project-card glass-card p-6 hover:shadow-glow-strong transition-all duration-500 group">
